CREATE TABLE IF NOT EXISTS branches (
	id INT PRIMARY KEY, last_updated BIGINT NOT NULL DEFAULT 0, 
	last_closed BIGINT NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS vouchers_last_updated(last_updated BIGINT NOT NULL DEFAULT 0);
